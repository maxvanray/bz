        ...
        <?php while ( have_rows('categories') ) : the_row();
              ...
              $images = get_sub_field('gallery');
                ...
                if( $images ):
                  ...
                  <div class="col-md-2 col-sm-6 col-xs-6 <?php echo $galleryCollection; ?>">
                    <a href="<?php echo $image['url']; ?>" class="zoom">
                      <div class="grid-item">
                        ...
                        <img src="<?php echo $image['sizes']['thumbnail']; ?>" class="img-responsive"  alt="<?php echo $image['title']; ?>" title="<?php echo $image['title']; ?>">
                      </div>
                    </a>
                  </div><!-- /.column -->
